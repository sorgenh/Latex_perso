...
\section{Expériences}
\cventry{Nov 2019 -- Fév 2020}{Senior Data Engineer}{Ermes}{}{}{
	Création et mise en place d'un cluster Spark sur un Kubernetes managé (OVH Public Cloud), avec Openstack Swift en Data Layer. Création du cluster, des outils d'administration de celui ci (playbooks ansible), transfert de workflows vers cette nouvelle plateforme, accompagnement des data scientist, mise en place de bonnes pratiques.
}
